...
One caution on the demo case: the picker still lists `00053`, which was generated by the superseded
pre-retrain checkpoint and whose scene is not in the current split at all. **Demo `00223`.**
